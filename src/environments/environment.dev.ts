...
export const properties = {
  ...
  kongApiUrl: 'https://athena.dev.auckland.ac.nz/wrapi/gateway',
  elkApiUrl: 'https://athena.dev.auckland.ac.nz/wrapi/apielk',
  athenaApi: 'https://athena.dev.auckland.ac.nz/wrapi/athena',
  repo: 'bitbucket.org',
  repoTeam: 'uoa',
  springStarterUrl: 'https://athena.dev.auckland.ac.nz/wrapi',
